...
#
# Generated by Vivado on Sat Jun 26 14:22:58 +07 2021
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../RISC-V-syn.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../RISC-V-syn.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../RISC-V-syn.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/ALU.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Branch_Comparator.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Control_Unit.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Execute_Unit.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Forwarding_Unit.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Hazard_Detection_Unit.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Imm_Gen.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Reg_PC.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/State_IF_fpga.v" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/mux2_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../RISC-V-syn.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Reg_EX_MEM.sv" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Reg_ID_EX.sv" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Reg_IF_ID.sv" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Reg_MEM_WB.sv" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Register_Array.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../RISC-V-syn.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/design_1/ipshared/c922/sim/Risc_32_bit_fpga.v" \
    "$ref_dir/../../../bd/design_1/ip/design_1_Risc_32_bit_fpga_0_0/sim/design_1_Risc_32_bit_fpga_0_0.v" \
